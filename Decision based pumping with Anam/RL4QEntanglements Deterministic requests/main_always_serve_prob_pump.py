...
from solvers import always_serve_prob_pump
...
def train_env(env_creator, prob_pump, results_dir):
    solver = always_serve_prob_pump.ASPP(env_creator, prob_pump, results_dir=results_dir)
...
if __name__ == '__main__':
    ...
    save_data(results_dir, request_arrival_rates,
              ...
              # F_R_1, F_R_2,
              F_R_all,
              eta_db, eta_linear, l_km, p_g, t_c, ppo_actions_discrete, c, sample_size, prob_pump)
    ...
    train_env(env_creator, prob_pump, results_dir=results_dir)
