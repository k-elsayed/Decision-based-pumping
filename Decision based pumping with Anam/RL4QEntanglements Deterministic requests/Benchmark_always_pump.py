...
class benchmark:
    ...
    def serve(self):
        ...
        self.service=np.append(self.service,-np.maximum(self.F_r-self.F_e,0))
        self.F_e=0
        self.flag = 0
        self.waiting_time = 0
...
run_param_path = '/home/karim/My Work/Codes/Decision based pumping with Anam/RL4QEntanglements/Results/Parameter_Files/Eval/run_params_4Pois_eval.json'
