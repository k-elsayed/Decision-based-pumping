...
request_arrival_rates = [4000, 5000, 6000, 7000]
F_R_all = [0.95, 0.85, 0.65, 0.55]
...
sample_size = 5000
T = sample_size*delta_t_g  # time horizon in ms
...
create_directory(results_dir)
results_dir=results_dir.joinpath('Eval')
create_directory(results_dir)
save_params_to_file(run_params, results_dir.joinpath('run_params_{}Pois_eval.json'.format(len(request_arrival_rates))))  # use if you want to save datewise